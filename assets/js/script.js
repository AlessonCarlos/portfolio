...
async function getAboutGithub() {
    try{
        const resposta = await fetch('https://api.github.com/users/AlessonCarlos');
        ...
        about.innerHTML = `
            ...
            <article class="about-content">
                <h2>Sobre mim</h2>
                <p>
                     Sou Desenvolvedor Full Stack JavaScript em formação pelo bootcamp da Generation Brasil, focado em criar soluções modernas, funcionais e bem estruturadas. Tenho base sólida em lógica de programação, orientação a objetos e bancos de dados SQL, além de experiência prática no desenvolvimento de aplicações web.
                </p>
                <p>
                   O que eu faço
                   Desenvolvo e estudo aplicações utilizando JavaScript, HTML, CSS e frameworks modernos como NestJS, sempre buscando escrever código limpo, organizado e escalável. Tenho interesse tanto em backend quanto frontend, com foco em construir sistemas completos, do banco de dados até a interface do usuário.
                </p>
...
async function getProjectsGithub() {
    try{
        const resposta = await fetch('https://api.github.com/users/AlessonCarlos/repos?sort=updated&per_page=6');
...
// Função de incialização do Carrosel - Swiper
